...
import Winners from './components/Winners'; // Adjust the path if necessary
import PastWinners from './components/PastWinners'; // Adjust the path if necessary
        ...
        <nav className="bg-purple-600 p-4">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4 mb-8">
              ...
              {/* Button to view past winners */}
              <button 
                onClick={() => setCurrentPage('pastWinners')} 
